...
fe_mse = mean_square_error(u_fe[-1], anal_u)
be_mse = mean_square_error(u_be[-1], anal_u)
cn_mse = mean_square_error(u_cn[-1], anal_u)
...
print('---------------------')
print(f'Mean square error between numerical and analytical solution  : {fe_mse:.2E}')
...
print('---------------------')
print(f'Mean square error between numerical and analytical solution : {be_mse:.2E}')
...
print('----------------------')
print(f'Mean square error between numerical and analytical solution  : {cn_mse:.2E}')
...
while not mse_close and mt_be > 1:
    ...
    be_mse_vary_mt = mean_square_error(anal_u, u_be[-1])

    mse_close = np.isclose(be_mse_vary_mt, fe_mse, atol=0, rtol=0.05)
    #print(mse_close)

print(f'Mean square errors of forward euler and backward euler within tolerance : \n'
        f'{mse_close}')
...
while not mse_close and mt_cn > 1:
    ...
    cn_mse_vary_mt = mean_square_error(anal_u, u_cn[-1])

    mse_close = np.isclose(cn_mse_vary_mt, fe_mse, atol=0, rtol=0.05)
    #print(mse_close)

print(f'Mean square errors of forward euler and crank nicholson within tolerance : \n'
        f'{mse_close}')
...
print(f'For mean square error within 5% of each other between backward euler'
        'and forward euler:\n')
...
print(f'For mean square error within 5% of each other between Crank Nicholson'
        'and forward euler:\n')
print(f'Forward euler average time   : {fe_avg:.2E}')
